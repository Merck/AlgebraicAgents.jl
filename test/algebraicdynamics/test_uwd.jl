...
rabbitfox_predation = @wrap "rabbitfox_predation" ContinuousResourceSharer{Float64}(2,
                                                                                    dotrf)
...
# Compose
rabbitfox_system = ⊕(rabbit_growth, rabbitfox_predation, fox_decline, diagram = rf,
